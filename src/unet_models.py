...
class UNet11(nn.Module):
    def __init__(self, num_filters=32, num_classes=1, pretrained=False):
        """
        :param num_classes:
        :param num_filters:
        :param pretrained:
...
class AlbuNet(nn.Module):
    ...
    def __init__(self, class_model, num_classes=1, num_filters=32, is_deconv=False):
        """
        :param num_classes:
        :param num_filters:
        :param pretrained:
